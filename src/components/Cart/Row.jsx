...
import {removeFromCart, updateCart} from "../../lib/redux/reducers/cart";
...
function Row({id, name, price, quantity, category, imageUrl}) {
    ...
    const handleOnChange = (e) => {
        ...
        const {updateQuantity} = useCart();// Appelle l'action pour mettre à jour la quantité dans le panier
